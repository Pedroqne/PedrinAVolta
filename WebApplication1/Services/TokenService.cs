...
namespace WebApplication1.Services
{
    public class TokenService : ITokenService
    {
        ...
        {
            var key = _config.GetSection("JWT").GetValue<string>("SecretKey") ?? throw new InvalidOperationException("Invalid SecretKey");
        ...
        public string GenerateRefreshToken()
        {
            ...
            using var randomNumberGeneretor = RandomNumberGenerator.Create();

            randomNumberGeneretor.GetBytes(securityRandomBytes);
